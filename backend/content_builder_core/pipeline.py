...
def available_pipelines() -> dict[str, ContentPipeline]:
    from content_builder_zh.integrated_chinese.pipeline import PIPELINE as integrated_chinese
    from content_builder_en.new_concept_english.pipeline import PIPELINE as new_concept_english
